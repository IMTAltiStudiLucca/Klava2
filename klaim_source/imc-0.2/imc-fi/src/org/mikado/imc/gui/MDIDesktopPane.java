 ...
 * 
 * This is based <a
 * href=http://www.javaworld.com/javaworld/jw-05-2001/jw-0525-mdi.html>on the
...
public class MDIDesktopPane extends JDesktopPane {
    ...
    public Component add(JInternalFrame frame) {
        ...
        /*
         * int w; int h; if (frame.isResizable()) { w = getWidth() - (getWidth() /
         * 3); h = getHeight() - (getHeight() / 3); if (w <
         * frame.getMinimumSize().getWidth()) w = (int)
         * frame.getMinimumSize().getWidth(); if (h <
         * frame.getMinimumSize().getHeight()) h = (int)
         * frame.getMinimumSize().getHeight(); frame.setSize(w, h); }
         */
...
class MDIDesktopManager extends DefaultDesktopManager {
    ...
    private Insets getScrollPaneInsets() {
        ...
        if (scrollPane == null)
            ...
            if (getScrollPane().getBorder() != null)

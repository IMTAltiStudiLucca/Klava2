...
/**
 * Uses a Marshaler attached to System.out and an UnMarshaler attached to
 * System.in. Uses an IncrementProtocolLayer.
 * 
 * @author Lorenzo Bettini
 * @version $Revision: 1.1 $
 */
public class IncrementLayerExample {
    public static void main(String args[]) throws Exception {
        ...
        protocolStack.insertLayer(new ProtocolLayerEndPoint(new IMCUnMarshaler(
                System.in), new IMCMarshaler(System.out)));
